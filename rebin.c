...
int nb;
{
  ...
  printf("NsecNew = %d,\t NsecOld = %d\n", NSEC, OldNSEC);
  printf("NradNew = %d,\t NradOld = %d\n", GLOBALNRAD, OldNRAD);
...
//Sareh added these lines for the full radiative disc ice line project.
//We would like to know the energy terms
    case 5: sprintf (radix, "Opacity"); break;
    case 6: sprintf (radix, "StarIrradiation"); break;
    case 7: sprintf (radix, "ThermalCooling"); break;
    case 8: sprintf (radix, "ViscousHeating"); break;
    }
    for (i = 0; i < GLOBALNRAD; i++) {
